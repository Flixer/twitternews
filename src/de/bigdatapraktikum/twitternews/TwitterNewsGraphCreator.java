...
public class TwitterNewsGraphCreator {
	...
	// returns the co-occurrence graph with the help of the TwitterNewsTopicAnalysis
	//public Graph<String, NullValue, Integer> getCoOccurrenceGraph() throws Exception{
	...
	DataSet<Tuple2<Long,String>> aggregatedWordsinTweets = filteredWordsInTweets.groupBy(0).reduce(new ReduceFunction<Tuple2<Long,String>>() {
